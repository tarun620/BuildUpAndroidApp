...
import com.example.buildup.databinding.ActivityForgetPasswordOtpBinding
import com.google.android.material.snackbar.Snackbar


class ForgetPasswordOtpActivity : AppCompatActivity() {

    private lateinit var _binding: ActivityForgetPasswordOtpBinding
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        _binding = ActivityForgetPasswordOtpBinding.inflate(layoutInflater)
        ...
        _binding?.apply {
            verifyOTP.setOnClickListener {
                ...
                authViewModel.resp.observe({lifecycle}){
                    if(it?.success!!){
                        Toast.makeText(this@ForgetPasswordOtpActivity,it.message, Toast.LENGTH_SHORT).show()
                        val intent=Intent(this@ForgetPasswordOtpActivity, ChangePasswordActivity::class.java)
                        intent.putExtra("mobileNo",mobileNoEditText)
                        startActivity(intent)
                    }
                    else{
                        Toast.makeText(this@ForgetPasswordOtpActivity,it.error, Toast.LENGTH_SHORT).show()
